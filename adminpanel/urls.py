...
urlpatterns = [
    ...
    path("refund-to-wallet/<int:id>/", views.refund_to_wallet, name="refund_to_wallet"),
    ...
    # sloper subscription
    path("edit-sloper-landing-page/", views.edit_sloper_landing_page, name="edit_sloper_landing_page"),
    ...
    path("sloper-subscription-management", views.sloper_subscription_management, name='sloper_subscription_management')
    # sloper subscription
]
