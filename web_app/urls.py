...
urlpatterns = [
     ...
     path('web_verify_mail/<str:email>/', views.web_verify_mail, name='web_verify_mail'),
     ...
     path('mobile_update/<str:new_mobile>', views.mobile_update, name = "mobile_update"),
     path('resend_otp_mobile/<str:new_mobile>', views.resend_otp_mobile, name = "resend_otp_mobile"),
     ...
     path("unsubscribe_to_blog/<str:email>/", views.unsubscribe_to_blog, name="unsubscribe_to_blog"),
     path("unsubscribe_to_newsletter/<str:email>/", views.unsubscribe_to_newsletter, name="unsubscribe_to_newsletter"),
