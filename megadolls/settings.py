...
# SECRET_KEY = "django-insecure-u$bikbpl^iz7e^qr6tc60!#@n@3a1v6ewhsxsez^h34vj7*jh("
SECRET_KEY = config('SECRET_KEY')

DEBUG = config('DEBUG', default=True, cast=bool)


ALLOWED_HOSTS = ["megadolls.devtechnosys.tech", "44.207.178.67", "172.16.2.188", "44.228.27.210", "192.168.1.206", "127.0.0.1", "staging-megadolls.devtechnosys.tech", "44.208.89.37", "192.168.1.114", "007c-14-99-33-182.ngrok.io", "[::]", "stage.megadolls.com", "192.168.1.95", "megadolls.com", "172.16.3.2", "192.168.1.201"]
